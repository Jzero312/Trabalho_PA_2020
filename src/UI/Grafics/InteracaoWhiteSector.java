 ...
 * @author ze1
 */
public class InteracaoWhiteSector extends Pane {
    ...
    public InteracaoWhiteSector(GameObservavel gameObservavel) {
    ...
    private void organizaComponentes() {
        ...
        BackgroundImage myBI= new BackgroundImage(Imagens.getImagem(ConstantesGui.FUNDO_WHITE_SECTOR),
    ...
    private void atualizaVista() {
        if(gameObservavel.getStateInfo() == StatesInfo.AAWS){
            refreshView();
            setVisible(true);
        }
        else
    ...
    private void organizaInfo(){
        ...
        //teste.setImage(Imagens.getImagem(ConstantesGui.BLACKPLANET));
    }
